[cw-sdk-node - v1.0.0-beta.6](../README.md) › [StreamOpts](streamopts.md)
...
*Defined in [src/websocket/types/client.ts:36](https://github.com/cryptowatch/cw-sdk-node/blob/bf249b1/src/websocket/types/client.ts#L36)*
