[cw-sdk-node - v1.0.0-beta.4](../README.md) › [StreamOpts](streamopts.md)
...
*Defined in [src/websocket/types/client.ts:36](https://github.com/cryptowatch/cw-sdk-node/blob/4ac4429/src/websocket/types/client.ts#L36)*
