[cw-sdk-node - v1.0.0-beta.7](../README.md) › [TradeOpts](tradeopts.md)
...
*Defined in [src/websocket/types/client.ts:40](https://github.com/cryptowatch/cw-sdk-node/blob/master/src/websocket/types/client.ts#L40)*
