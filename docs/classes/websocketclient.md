[cw-sdk-node - v1.0.0-beta.4](../README.md) › [WebSocketClient](websocketclient.md)
...
*Defined in [src/websocket/WebSocketClient.ts:64](https://github.com/cryptowatch/cw-sdk-node/blob/53b8a13/src/websocket/WebSocketClient.ts#L64)*
